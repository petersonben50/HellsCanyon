#### code/manuscript_figures/supplemental/hg_RM286.R ####
# Benjamin D. Peterson
...
pdf("results/manuscript_figures/supplemental_hg/RM286_hg.pdf",
    height = 6,
    width = 5)
par(mfrow = c(2, 4),
    mgp=c(1.5,0.4,0),
...
lines(x = Hg.data.2018$FMHG_per,
      ...
      col = cb.translator["black"],
      lwd = 0.8)
points(x = Hg.data.2018$PMHG_per,
       y = Hg.data.2018$depth,
       col = cb.translator["black"],
       pch = 5,
       lwd = 0.8)
lines(x = Hg.data.2018$PMHG_per,
      y = Hg.data.2018$depth,
      col = cb.translator["black"],
      lwd = 0.8)
# Add legend
