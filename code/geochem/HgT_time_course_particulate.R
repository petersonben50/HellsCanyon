...
function.of.function <- function(year.you.want) {
  time.course.profile.plot(geochem.data.to.use = geochem.data.of.interest,
                           ...
                           concentrations.to.use = c(0, 6),
                           RMs.to.use = c(286,300, 310),
                           parameter.to.plot = "HgT_part_ngL",
                           xlabel.to.use = "Particulate HgT (ng/L)",
...
pdf("results/geochem/HgT_time_course_particulate.pdf",
    width = 7,
    height = 8)
