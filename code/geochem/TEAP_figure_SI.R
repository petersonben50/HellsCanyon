...
geochem.2018.300 <- plot.DO.nitrate.Mn.sulfide.profile(geochem.data.of.interest = geochem.data,
                                                       ...
                                                       legend.location.of.interest = "none",
                                                       scaling.vector.to.use = scaling.vector)
geochem.2019.300 <- plot.DO.nitrate.Mn.sulfide.profile(geochem.data.of.interest = geochem.data,
                                                       RM.of.interest = 300,
                                                       ...
                                                       legend.location.of.interest = "none",
                                                       scaling.vector.to.use = scaling.vector)
geochem.2019.310 <- plot.DO.nitrate.Mn.sulfide.profile(geochem.data.of.interest = geochem.data,
                                                       RM.of.interest = 310,
