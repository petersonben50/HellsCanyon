...
sonde.2017.286 <- sonde.profile(seabird.data.of.interest = seabird.data,
                                RM.of.interest = 286,
                                year.of.interest =  2017,
                                depth.range.of.interest = c(75, 0),
                                concentration.of.interest = c(0, 25),
                                legend.location.of.interest = c(0.8, 0.2),
                                scaling.vector.to.use = scaling.vector,
                                color.vector.to.use = color.vector)
sonde.2017.300 <- sonde.profile(seabird.data.of.interest = seabird.data,
                                RM.of.interest = 300,
                                year.of.interest =  2017,
                                depth.range.of.interest = c(75, 0),
                                concentration.of.interest = c(0, 25),
                                ...
                                scaling.vector.to.use = scaling.vector,
                                color.vector.to.use = color.vector)
sonde.2018.286 <- sonde.profile(seabird.data.of.interest = seabird.data,
                                RM.of.interest = 286,
                                ...
                                scaling.vector.to.use = scaling.vector,
                                color.vector.to.use = color.vector)
sonde.2018.300 <- sonde.profile(seabird.data.of.interest = seabird.data,
                                RM.of.interest = 300,
                                year.of.interest =  2018,
                                depth.range.of.interest = c(75, 0),
                                concentration.of.interest = c(0, 25),
...
Hg.2017.286 <- plot.redox.profile(geochem.data.of.interest = geochem.data,
                                  RM.of.interest = 286,
                                  date.of.interest = "2017-09-25",
                                  depth.range.of.interest = c(75, 0),
                                  ...
                                  legend.location.of.interest = c(0.8, 0.5),
                                  scaling.vector.to.use = scaling.vector)
Hg.2017.300 <- plot.redox.profile(geochem.data.of.interest = geochem.data,
                                  RM.of.interest = 300,
                                  date.of.interest = "2017-09-26",
                                  depth.range.of.interest = c(75, 0),
                                  concentration.of.interest = Hg.concentration.range.to.use,
                                  legend.location.of.interest = "none",
                                  scaling.vector.to.use = scaling.vector)
Hg.2018.286 <- plot.redox.profile(geochem.data.of.interest = geochem.data,
                                  RM.of.interest = 286,
                                  date.of.interest = "2018-09-24",
                                  depth.range.of.interest = c(75, 0),
                                  concentration.of.interest = Hg.concentration.range.to.use,
                                  legend.location.of.interest = "none",
                                  scaling.vector.to.use = scaling.vector)
Hg.2018.300 <- plot.redox.profile(geochem.data.of.interest = geochem.data,
                                  RM.of.interest = 300,
                                  date.of.interest = "2018-09-25",
                                  depth.range.of.interest = c(75, 0),
                                  concentration.of.interest = Hg.concentration.range.to.use,
