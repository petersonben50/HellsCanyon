...
#### Plot up RAxML tree from final alignment ####
...
hgcA.tree <- root(phy = hgcA.tree.unrooted,
                  outgroup = c("paralog_Thermosulfurimonas_dismutans",
                               "paralog_Candidatus_Omnitrophica_bacterium_CG1_02_41_171"),
                  edgelabel = TRUE)
...
# Visualize tree
pdf("results/hgcA_analysis/hgcA_tree_for_ref_selection.pdf",
    height = 60,
    width = 10)
